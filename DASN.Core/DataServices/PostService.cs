...
namespace DASN.Core.DataServices
{
    public class PostService
    {
        ...
        public List<Post> GetPostsByUser(ApplicationUser user, int skip = 0, int take = 10) => _context.Posts
        ...
        public Post AddPost(string title, string content, bool isPublic, DateTime createdAt, string userId)
        {
